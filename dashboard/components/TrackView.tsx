...
export default function TrackView({
	...
	const hasRealSensorData = dataWithCoordinates.some(
		(p) =>
			p.LatAccel !== undefined ||
			p.LongAccel !== undefined ||
			p.Alt !== undefined,
	);
					...
					<div className="h-[600px] bg-gray-700 flex items-center justify-center">
						<div className="text-center p-8">
							...
							<p className="text-gray-500 text-sm max-w-md">
								...
								invalid. Make sure your telemetry data includes Lat/Lon fields.
							</p>
						</div>
					</div>
				)}
